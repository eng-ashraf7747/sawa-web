...
export default function Hero({ onRegisterClick }: HeroProps) {
  return (
    <section className="max-w-6xl mx-auto px-6 md:px-12 pt-8 pb-0 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
      <div className="text-center md:text-right">
        ...
        <h1 className="text-3xl md:text-5xl font-black leading-tight text-[#0d2447] mb-5">
          لوحدك بتدفع أكتر.<br/>
          مع <span className="text-[#c9a84c]">SAWA</span> بتدفع أقل.
        </h1>
        <p className="text-sm md:text-base text-[#6b7280] leading-relaxed mb-8 max-w-md mx-auto md:mx-0">
        ...
        <div className="flex gap-3 flex-wrap justify-center md:justify-start mb-10">
          <button
            ...
            className="bg-[#1a3c6e] text-white px-6 md:px-8 py-3.5 rounded-xl font-bold text-base hover:bg-[#0d2447] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-900/25 transition-all cursor-pointer"
          >
            🚀 ابدأ مجاناً
          </button>
